    ...
    if(isset($_POST['update'])){
        ...
        if($nameError == '' && $numError == '' && $phoneError == '' && $emailError == '' && $noChangeError == ''){
            ...
            if($result2){
                ...
                $to =$email;
                $subject = 'Changes Made to Your User Profile';
                $message = 'We apologize for any inconvenience this may have caused you. However, we assure you that these changes were necessary to ensure that your profile is accurate and up-to-date.';
                $headers = 'From: openmail12345678@gmail.com' . "\r\n" .
                            'Reply-To: openmail12345678@gmail.com' . "\r\n" .
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark pt-4 pb-4">
        ...
        <ul class="navbar-nav">
            ...
            <a class="nav-link active ms-2 me-2 fw-bold " id="profile" href="profile.php" role="button">
                Profile
            </a>
            </li>
            <li class="nav-item">
                <a href="mail.php" id="mail" class="nav-link active ms-2 me-2 fw-bold" >Mail</a>
            </li>
            <li class="nav-item">
                <a href="admin.php" id="admin" class="nav-link active ms-2 me-2 fw-bold" >Admin</a>
            </li>
            <li class="nav-item">
            ...
            <div class="col-md-6 mt-5 pt-5 border border-2 rounded-3 bg-white">
                <form action="#" method="POST">
                    ...
                    <div class="d-flex justify-content-center">
                        <button class="btn btn-primary mb-2 " name="update">Save</button>               
                        </div>                   
                    </div>
                </from>
            </div>  
    ...
    if(isset($_GET['role'])){
        ...
        ?>
            <script>
                    ...
                    m = document.getElementById('profile'); 
